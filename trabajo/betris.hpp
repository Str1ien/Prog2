...
// Date:   mayo 2022
// Coms:   Fichero de interfaz del módulo «betris» del trabajo 
...
struct tpTablero{
    ...
    int matriz[MAXDIM][MAXDIM]; // El valor de cada celda indica el numero de
                                ...
                                // Las coordenadas de la casilla de arriba a la 
                                // izquierda son (0,0)
};
...
struct tpPieza{
   ...
   int forma[TAMPIEZA][2]; // Coordenadas de los cuadrados de la pieza
                           // El primer valor es el número de fila, 
                           // el segundo es el número de columna
...
const tpPieza vPiezas[PIEZASDEF] = {
    {AZUL,     {{0,0}, {0,1}, {0,2}, {0,3}}}, // 0  ####
    {VERDE,    {{0,0}, {1,0}, {2,0}, {3,0}}}, // 1  #
                                              //    #
                                              //    #
                                              //    #
    {ROJO,     {{0,0}, {0,1}, {1,0}, {2,0}}}, // 2  ##
                                              //    #
                                              //    #
    {CIAN,     {{0,0}, {0,1}, {0,2}, {1,2}}}, // 3  ###
                                              //      #
    {AMARILLO, {{0,0}, {0,1}, {1,0}, {1,1}}}  // 4  ##
                                              //    ##
};
...
// Pre:  vEntrada contiene los números de las piezas que entran y tablero contiene el estado
//		 actual del tablero, en el que pueden estar colocadas algunas de dichas piezas 
...
// Pre:  En el tablero se han colocada las n primeras piezas de vEntrada, en la columnas
//		 indicadas respectivamente en vSalida
