...
// Post: Ha calculado el intervalo con mayor fin de la primera mitad, y ha devuelto el 
//		 índice de dicho intervalo en el vector de intervalos «indinters».
